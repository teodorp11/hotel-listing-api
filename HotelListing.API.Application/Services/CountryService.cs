...
public class CountryService(HotelListingDbContext context, IMapper mapper, IMemoryCache cache) : ICountryService
{
    private const string CountryCacheName = "country_";
    ...
    {
        cache.Remove($"{CountryCacheName}{id}");
    }
}
