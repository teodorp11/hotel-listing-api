...
/// <summary>
/// A sample controller used to demonstrate and test Basic Authentication.
/// </summary>
...
{
    /// <summary>
    /// Retrieves a list of sample values. Requires Basic Authentication.
    /// </summary>
    /// <returns>An array of sample strings.</returns>
    /// <response code="200">Returns the list of sample values.</response>
    /// <response code="401">If the Basic Authentication credentials are missing or invalid.</response>
    [HttpGet]
    ...
    /// <summary>
    /// Retrieves a specific sample value by its identifier. Requires Basic Authentication.
    /// </summary>
    ...
    /// <summary>
    /// Submits a new sample value to the server. Requires Basic Authentication.
    /// </summary>
    ...
    /// <summary>
    /// Updates an existing sample value on the server. Requires Basic Authentication.
    /// </summary>
    ...
    /// <summary>
    /// Deletes a specific sample value from the server. Requires Basic Authentication.
    /// </summary>
